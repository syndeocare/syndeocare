...
const en = {
  ...
  "conversation.filePreview": "File ready to send",
  "conversation.fileAttachment": "File",
  "conversation.imageAttachment": "Image",
  "conversation.imagePreview": "Image ready to send",
  "conversation.loading": "Loading conversation...",
  "conversation.message": "Message",
  "conversation.messagePlaceholder": "Write a clear message...",
  "conversation.pdfPreview": "PDF ready to send",
  "conversation.removeFile": "Remove",
  "conversation.send": "Send",
  "conversation.secureThread": "Secure conversation",
  "conversation.title": "Conversation",
  "conversation.videoAttachment": "Video",
  "conversation.videoPreview": "Video ready to send",
  ...
  "onboarding.submitted": "Submitted for admin review.",
  ...
  "profile.deleteAccountBody":
    "This permanently deletes your SyndeoCare account, profile, and access. This action cannot be undone.",
  ...
  "shifts.amountRangeInvalid": "Enter a realistic hourly rate in Yemeni rials.",
  ...
  "shifts.editShiftBody": "Update the details visible to applicants.",
  ...
  "shifts.myActiveBookings": "My active bookings",
  ...
  "shifts.noMyShiftsBody":
    "Create your first shift to start receiving applications.",
  "shifts.noMyShiftsTitle": "No shifts yet",
  ...
  "shifts.reopenShift": "Reopen shift",
...
const ar: Record<TranslationKey, string> = {
  ...
  "conversation.filePreview": "ملف جاهز للإرسال",
  "conversation.fileAttachment": "ملف",
  "conversation.imageAttachment": "صورة",
  "conversation.imagePreview": "صورة جاهزة للإرسال",
  "conversation.loading": "جاري تحميل المحادثة...",
  "conversation.message": "الرسالة",
  "conversation.messagePlaceholder": "اكتب رسالة واضحة...",
  "conversation.pdfPreview": "ملف PDF جاهز للإرسال",
  "conversation.removeFile": "إزالة",
  "conversation.send": "إرسال",
  "conversation.secureThread": "محادثة آمنة",
  "conversation.title": "المحادثة",
  "conversation.videoAttachment": "فيديو",
  "conversation.videoPreview": "فيديو جاهز للإرسال",
  ...
  "onboarding.submitted": "تم الإرسال لمراجعة الإدارة.",
  ...
  "profile.deleteAccountTitle": "حذف حسابك؟",
  "profile.deleteAccountBody":
    "سيؤدي ذلك إلى حذف حسابك وملفك ووصولك إلى SyndeoCare نهائياً. لا يمكن التراجع عن هذا الإجراء.",
  ...
  "shifts.amountRangeInvalid": "أدخل أجراً واقعياً بالساعة بالريال اليمني.",
  "shifts.applicationsBody":
  ...
  "shifts.closeShift": "إغلاق المناوبة",
  "shifts.checkIn": "تسجيل الحضور",
  "shifts.checkOut": "تسجيل الانصراف",
  "shifts.decline": "رفض",
  "shifts.description": "الوصف",
  "shifts.detailsRequired": "أضف ملخصاً ووصفاً ومتطلباً واحداً على الأقل.",
  "shifts.editShift": "تعديل المناوبة",
  "shifts.editShiftBody": "حدّث التفاصيل التي تظهر للمتقدمين.",
  ...
  "shifts.myActiveBookings": "حجوزاتي النشطة",
  "shifts.myShifts": "مناوباتي",
  "shifts.next": "التالي",
  ...
  "shifts.noMyShiftsBody": "أنشئ أول مناوبة لديك لبدء استقبال الطلبات.",
  "shifts.noMyShiftsTitle": "لا توجد مناوبات بعد",
  ...
  "shifts.reopenShift": "إعادة فتح المناوبة",
