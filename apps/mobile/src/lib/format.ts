...
const arabicLabelMap = new Map<string, string>([
  ...
  ["filled", "مكتملة"],
  ["closed", "مغلقة"],
  ["temporary_shift", "مناوبة مؤقتة"],
  ["temporary shift", "مناوبة مؤقتة"],
  ["permanent_role", "وظيفة دائمة"],
  ["permanent role", "وظيفة دائمة"],
  ["contract", "عقد"],
  ["direct_phone", "اتصال مباشر"],
  ["direct phone", "اتصال مباشر"],
  ["in_app_chat", "محادثة داخل التطبيق"],
  ["in app chat", "محادثة داخل التطبيق"],
  ...
  ["network request failed", "تعذر الاتصال بالشبكة. يرجى المحاولة مرة أخرى."],
  [
...
const englishLabelMap = new Map<string, string>([
  ...
  ["failed to fetch", "Could not connect. Check your network and try again."],
  [
